...
public class VirtualFibreChannelSwitches
{

	private String query = "UNWIND {objects} as object CREATE (vfcs:VirtualFibreChannelSwitch) SET vfcs = object";
	private HashMap<String,ArrayList<VirtualFibreChannelSwitch>> params = new HashMap<String,ArrayList<VirtualFibreChannelSwitch>>();
	
	//////////////////////////////////////////////////////////////////////
	
	public VirtualFibreChannelSwitches()
	{
	...
	{
		ArrayList<VirtualFibreChannelSwitch> objects = new ArrayList<VirtualFibreChannelSwitch>();
...
//			System.out.println("*** " + rest_query_string);
			...
			if(json_response.getStatus() == 200)
			{
				...
				{
					gson = new Gson();
					objects.add(gson.fromJson(node.toString(), VirtualFibreChannelSwitch.class));
				}
			}	
		}
	...
	public HashMap<String, ArrayList<VirtualFibreChannelSwitch>> getParams()
	{
		return this.params;
	}
